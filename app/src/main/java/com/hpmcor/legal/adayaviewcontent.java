...
public class adayaviewcontent extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_adayaviewcontent);
 adapter=new AdayaAdapter(this,listitem);
       ...
       list.setOnItemClickListener(new android.widget.AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(android.widget.AdapterView<?> parent, android.view.View view, int position, long id) {
                ...
                android.content.Intent intent=new android.content.Intent(adayaviewcontent.this,view2.class);
     ...
     public void showdata() {
        ...
        if (res2.getCount() == 0) {
            Toast.makeText(adayaviewcontent.this, "لا توجد بيانات " , Toast.LENGTH_LONG).show();
            ...
            while (res2.moveToNext()) {
                ...
                Word word = new Word(t1, t2, t3, t4, t5, t6, t7, t8, R.drawable.books);
                listitem.add(word);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        searchView.setOnQueryTextListener(new android.support.v7.widget.SearchView.OnQueryTextListener() {
            ...
            public boolean onQueryTextChange(String newText) {
                ...
                AdayaAdapter adapter=new AdayaAdapter(adayaviewcontent.this,userslist);
