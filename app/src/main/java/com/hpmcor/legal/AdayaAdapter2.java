...
public class AdayaAdapter2 extends ArrayAdapter<Word>{

    private static final String LOG_TAG = Wordadapt.class.getSimpleName();


    public   AdayaAdapter2 (Context context, ArrayList<Word> listitem  ) {
    ...
    public View getView(int position, View convert, ViewGroup parent) {
        ...
        if(listitem ==null){
            ...
            listitem= LayoutInflater.from(getContext()).inflate(R.layout.adayalistitem,parent,false);
