...
public class worksAdapter extends ArrayAdapter<Word>{

    private static final String LOG_TAG = Wordadapt.class.getSimpleName();


    public  worksAdapter(Context context, List<Word> listitem  ) {
    ...
    public View getView(int position, View convert, ViewGroup parent) {
        ...
        if(listitem ==null){
            ...
            listitem= LayoutInflater.from(getContext()).inflate(R.layout.works_listitem,parent,false);
